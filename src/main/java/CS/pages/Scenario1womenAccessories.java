...
public class Scenario1womenAccessories extends TestbaseS1 {
	...
	public Scenario1womenAccessories() {
	...
	public void enteruname(String user, String pass) throws InterruptedException {
		...
		upass.sendKeys(pass);
		signin.click();
		js.executeScript("window.location='https://crazystylezs.com/product-categories/makeup'");
		Thread.sleep(2000);
		js.executeScript("window.scrollBy(0,500)");
		js.executeScript("window.location='https://crazystylezs.com/products/flawless-finish-primer'");
